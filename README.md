...
dragonpilot (台灣FIT e-HEV 專用分支)

本分支專為 HONDA FIT e-HEV (2021+) 進行優化與調校。

最新版本： v0.10.3 r2 (更新於 2026-02-24)

支援車型： 於選單內選擇 FIT e-HEV 2021。

功能亮點

全速域跟車： 使用原廠鏡頭時，需開啟 OP LONG (長縱向控制) 即可達成跟車全速域。

車道維持 (LKAS)： 時速 23km/h 以上自動開啟；低於 23km/h 則自動關閉作動。
